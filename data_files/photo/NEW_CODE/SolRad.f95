...
!
! integer, parameter :: iFirst = 0, LimB = 2000, LimF = 1000, nF = 324, nSA = 162
integer, parameter :: iFirst = 0, LimB = 2000, LimF = 1000, nSA = 162
character (len = 3) :: RadField
...
!  open(unit =  7, status = "replace")           ! Scratch file for wavelengths and photon flux.
