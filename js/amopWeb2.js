...
function processLink(value) {
    $("window_area").update(); // -> HTMLElement
    $("window_area").innerHTML; // -> '' (an empty string)

    $("tab1_area").update(); // -> HTMLElement
    $("tab1_area").innerHTML; // -> '' (an empty string)

    $("tab2_area").update(); // -> HTMLElement
    $("tab2_area").innerHTML; // -> '' (an empty string)

    $("tab3_area").update(); // -> HTMLElement
    $("tab3_area").innerHTML; // -> '' (an empty string)

    $("tab4_area").update(); // -> HTMLElement
    $("tab4_area").innerHTML; // -> '' (an empty string)

    $("backtotop").update(); // -> HTMLElement
    $("backtotop").innerHTML; // -> '' (an empty string)
    ...
    if (value == "home") {
        ...
        document.getElementById("interstellar").className = "main_tabs_link_div";
        document.getElementById("solar").className = "main_tabs_link_div";
        new Ajax.Updater("mol_text_area", "./photo_form.html", {
            evalScripts: true,
        });
        ...
        document.getElementById("interstellar").className = "main_tabs_link_div";
        document.getElementById("solar").className = "main_tabs_link_div";
        new Ajax.Updater("mol_text_area", "./blackbody_form.html", {
            evalScripts: true,
        });
        ...
        document.getElementById("blackbody").className = "main_tabs_link_div";
        document.getElementById("solar").className = "main_tabs_link_div";
        new Ajax.Updater("mol_text_area", "./interstellar_form.html", {
            evalScripts: true,
        });
        ...
        document.getElementById("blackbody").className = "main_tabs_link_div";
        document.getElementById("interstellar").className = "main_tabs_link_div";
        new Ajax.Updater("mol_text_area", "./solar_form.html", {
            evalScripts: true,
        });
...
function homeSideMenuSelected(divName) {
    ...
    if (divName == "side_menu_info_div") {
        ...
        document.getElementById("side_menu_references_div").className = "home_side_menu_button";
        document.getElementById("side_menu_contact_div").className = "home_side_menu_button";
        new Ajax.Updater("home_text_area", "./home_info.html", {
            evalScripts: true,
        });
        /*** This ensures "Home" and "Info" content shows when the other side links are clicked before the top links. ****/
        document.getElementById("solar").className = "main_tabs_link_div";
        ...
        document.getElementById("side_menu_references_div").className = "home_side_menu_button";
        document.getElementById("side_menu_contact_div").className = "home_side_menu_button";
        new Ajax.Updater("home_text_area", "./photon.html", {
            evalScripts: true,
        });
        ...
        document.getElementById("side_menu_references_div").className = "home_side_menu_button";
        document.getElementById("side_menu_contact_div").className = "home_side_menu_button";
        new Ajax.Updater("home_text_area", "./usingwebsite.html", {
            evalScripts: true,
        });
        /*** This ensures "Home" and "Info" content shows when the other side links are clicked before the top links. ****/
        document.getElementById("solar").className = "main_tabs_link_div";
        ...
        document.getElementById("side_menu_usingwebsite_div").className = "home_side_menu_button";
        document.getElementById("side_menu_contact_div").className = "home_side_menu_button";
        new Ajax.Updater("home_text_area", "./references.html", {
            evalScripts: true,
        });
        /*** This ensures "Home" and "Info" content shows when the other side links are clicked before the top links. ****/
        document.getElementById("solar").className = "main_tabs_link_div";
        ...
        document.getElementById("side_menu_usingwebsite_div").className = "home_side_menu_button";
        document.getElementById("side_menu_references_div").className = "home_side_menu_button";
        new Ajax.Updater("home_text_area", "./contacts.html", {
            evalScripts: true,
        });
        /*** This ensures "Home" and "Info" content shows when the other side links are clicked before the top links. ****/
        document.getElementById("solar").className = "main_tabs_link_div";
...
function runMolecule(value) {
    ...
    if (justCrossSections == true) {
        ...
        //  url: cross_sections})
        //win.show();
        new Ajax.Updater("window_area", cross_sections, {
            evalScripts: true,
        });
        new Ajax.Updater("backtotop", "backtotop.html", {
            evalScripts: true,
        });
        ...
        if (document.options.plots_desired[0].checked == true) {
            ...
            //	url: solar_spectrum})
            //win.show();
            new Ajax.Updater("tab1_area", solar_spectrum, {
                evalScripts: true,
            });
            new Ajax.Updater("backtotop", "backtotop.html", {
                evalScripts: true,
        ...
        if (document.options.plots_desired[1].checked == true) {
            ...
            //		url: cross_sections})
            //win.show();
            new Ajax.Updater("tab2_area", cross_sections, {
                evalScripts: true,
            });
            new Ajax.Updater("backtotop", "backtotop.html", {
                evalScripts: true,
        ...
        if (document.options.plots_desired[3].checked == true) {
            ...
            //		url: excess_energies})
            //win.show();
            new Ajax.Updater("tab4_area", excess_energies, {
                evalScripts: true,
            });
            new Ajax.Updater("backtotop", "backtotop.html", {
                evalScripts: true,
...
function testNumbers() {
    ...
    if (justCrossSections == false) {
        if (useTemp == true) {
            ...
            if (isNumberString(temp) == false || isBetweenXY(temp, 1000, 1000000) == false) {
        ...
        if (useSolarActivity == true) {
            ...
            if (isNumberString(solar_activity) == false || isBetweenXY(solar_activity, 0, 1) == false) {
        ...
        if (useOpticalDepth == true) {
            ...
            if (isNumberString(optical_depth) == false || isBetweenXY(optical_depth, 0, 1) == false) {
